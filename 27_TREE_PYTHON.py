...
#            #class Octree:
    def insert(self, x, y, z):
        ...
        if tlf.z <= z <= _2_3z:
            ...
            if _2_3x + _000000000000001 <= x <= brb.x:
                if tlf.y <= y <= _1_3y:
            ...
            if tlf.x <= x <= _1_3x:
                if _2_3y + _000000000000001 <= y <= brb.y:
        ...
        if _2_3z + _000000000000001 <= z <= brb.z:
            if tlf.x <= x <= _1_3x:
                if tlf.y <= y <= _1_3y:
        ...
        if self.children[pos].point is None        or  self.children[pos].point == Point() :
            ...
            if pos == North_West_Surface:
                ...
                brb.y = _1_3y
                brb.z = _1_3z
                children[pos] = Octree(tlf.x, tlf.y, tlf.z, _1_3x, _1_3y, _1_3z)
                
            elif pos == North_Middle_Surface:
                tlf.x = _1_3x + _000000000000001
                tlf.y = tlf.y
                tlf.z = tlf.z
                brb.x = _2_3x
                brb.y = _1_3y
                brb.z = _1_3z
                children[pos] = Octree(_1_3x + _000000000000001, tlf.y, tlf.z, _2_3x, _1_3y, _1_3z)
                
            elif pos == North_East_Surface:
                tlf.x = _2_3x + _000000000000001
                tlf.y = tlf.y
                tlf.z = tlf.z
                brb.x = brb.x
                brb.y = _1_3y
                brb.z = _1_3z
                children[pos] = Octree(_2_3x + _000000000000001, tlf.y, tlf.z, brb.x, _1_3y, _1_3z)
                
            elif pos == Equator_West_Surface:
                tlf.x = tlf.x
                tlf.y = _1_3y + _000000000000001
                tlf.z = tlf.z
                brb.x = _1_3x
                brb.y = _2_3y
                brb.z = _1_3z
                children[pos] = Octree(tlf.x, _1_3y + _000000000000001, tlf.z, _1_3x, _2_3y, _1_3z)
                ...
                brb.y = _2_3y
                brb.z = _1_3z
                children[pos] = Octree(_1_3x + _000000000000001, _1_3y + _000000000000001, tlf.z, _2_3x, _2_3y, _1_3z)
                ...
                brb.y = _2_3y
                brb.z = _1_3z
                children[pos] = Octree(_2_3x + _000000000000001 , _1_3y + _000000000000001, tlf.z, brb.x, _2_3y, _1_3z)
                
            elif pos == South_West_Surface:
                tlf.x = tlf.x
                tlf.y = _2_3y + _000000000000001
                tlf.z = tlf.z
                brb.x = _1_3x
                brb.y = brb.y
                brb.z = _1_3z
                children[pos] = Octree(tlf.x, _2_3y + _000000000000001, tlf.z, _1_3x, brb.y, _1_3z)
                ...
                brb.y = brb.y
                brb.z = _1_3z
                children[pos] = Octree(_1_3x + _000000000000001, _2_3y + _000000000000001, tlf.z, _2_3x, brb.y, _1_3z)
                ...
                brb.y = brb.y
                brb.z = _1_3z
                children[pos] = Octree(_2_3x + _000000000000001, _2_3y + _000000000000001, tlf.z, brb.x, brb.y, _1_3z)
            ...
            #############################################################################################################################################################
                ...
                tlf.x = tlf.x
                tlf.y = tlf.y
                tlf.z = _1_3z + _000000000000001
                brb.x = _1_3x
                brb.y = _1_3y
                brb.z = _2_3z
                children[pos] = Octree(tlf.x, tlf.y, _1_3z + _000000000000001, _1_3x, _1_3y, _2_3z)
                ...
                brb.y = _1_3y
                brb.z = _2_3z
                children[pos] = Octree(_1_3x + _000000000000001, tlf.y, _1_3z + _000000000000001, _2_3x, _1_3y, _2_3z)
                ...
                brb.y = _1_3y
                brb.z = _2_3z
                children[pos] = Octree(_2_3x + _000000000000001, tlf.y, _1_3z + _000000000000001, brb.x, _1_3y, _2_3z)
                ...
                brb.y = _2_3y
                brb.z = _2_3z
                children[pos] = Octree(tlf.x, _1_3y + _000000000000001, _1_3z + _000000000000001, _1_3x, _2_3y, _2_3z)
                ...
                brb.y = _2_3y
                brb.z = _2_3z
                children[pos] = Octree(_1_3x + _000000000000001, _1_3y + _000000000000001, _1_3z + _000000000000001, _2_3x, _2_3y, _2_3z)
                ...
                brb.y = _2_3y
                brb.z = _2_3z
                children[pos] = Octree(_2_3x + _000000000000001, _1_3y + _000000000000001, _1_3z + _000000000000001, brb.x, _2_3y, _2_3z)
                ...
                brb.y = brb.y
                brb.z = _2_3z
                children[pos] = Octree(tlf.x, _2_3y + _000000000000001, _1_3z + _000000000000001, _1_3x, brb.y, _2_3z)
                ...
                brb.y = brb.y
                brb.z = _2_3z
                children[pos] = Octree(_1_3x + _000000000000001, _2_3y + _000000000000001, _1_3z + _000000000000001, _2_3x, brb.y, _2_3z)
                ...
                brb.y = brb.y
                brb.z = _2_3z
                children[pos] = Octree(_2_3x + _000000000000001, _2_3y + _000000000000001, _1_3z + _000000000000001, brb.x, brb.y, _2_3z)
            ...
            #############################################################################################################################################################
                ...
                tlf.x = tlf.x
                tlf.y = tlf.y
                tlf.z = _2_3z + _000000000000001
                brb.x = _1_3x
                brb.y = _1_3y
                brb.z = brb.z
                children[pos] = Octree(tlf.x, tlf.y, _2_3z + _000000000000001, _1_3x, _1_3y, brb.z)
                ...
                brb.y = _1_3y
                brb.z = brb.z
                children[pos] = Octree(_1_3x + _000000000000001, tlf.y, _2_3z + _000000000000001, _2_3x, _1_3y, brb.z)
                ...
                brb.y = _1_3y
                brb.z = brb.z
                children[pos] = Octree(_2_3x + _000000000000001, tlf.y, _2_3z + _000000000000001, brb.x, _1_3y, brb.z)
                ...
                brb.y = _2_3y
                brb.z = brb.z
                children[pos] = Octree(tlf.x, _1_3y + _000000000000001, _2_3z + _000000000000001, _1_3x, _2_3y, brb.z)
                ...
                brb.y = _2_3y
                brb.z = brb.z
                children[pos] = Octree(_1_3x + _000000000000001, _1_3y + _000000000000001, _2_3z + _000000000000001, _2_3x, _2_3y, brb.z)
                ...
                brb.y = _2_3y
                brb.z = brb.z
                children[pos] = Octree(_2_3x + _000000000000001, _1_3y + _000000000000001, _2_3z + _000000000000001, brb.x, _2_3y, brb.z)
                ...
                brb.y = brb.y
                brb.z = brb.z
                children[pos] = Octree(tlf.x, _2_3y + _000000000000001, _2_3z + _000000000000001, _1_3x, brb.y, brb.z)
                ...
                brb.y = brb.y
                brb.z = brb.z
                children[pos] = Octree(_1_3x + _000000000000001, _2_3y + _000000000000001, _2_3z + _000000000000001, _2_3x, brb.y, brb.z)
                ...
                brb.y = brb.y
                brb.z = brb.z
                children[pos] = Octree(_2_3x + _000000000000001, _2_3y + _000000000000001, _2_3z + _000000000000001, brb.x, brb.y, brb.z)
...
def main():
    ...
    tree.insert(1, 2, 3)
    tree.insert(1, 2, 3)  # Point already exists in the tree
    tree.insert(6, 5, 5)  # Point is out of bound
    
    
    print("Found (1,2,3)" if tree.find(1, 2, 3) else "Not Found (1,2,3)") # Found
    
    print("Found (3,4,4)" if tree.find(3, 4, 4) else "Not Found (3,4,4)") # Not Found
    tree.insert(3, 4, 4)
    
    print("Found (3,4,4)" if tree.find(3, 4, 4) else "Not Found (3,4,4)") # Found
    
    
    
    #print("Found (1,2,3)" if tree.insert(1, 2, 3) else "Not Found (1,2,3)") # x
    
    #print("Found (3,4,4)" if tree.insert(3, 4, 4) else "Not Found (3,4,4)") # x
    #tree.insert(3, 4, 4) # x
    
    #print("Found (3,4,4)" if tree.insert(3, 4, 4) else "Not Found (3,4,4)") # x
    
    
    tree.insert(3, 4, 4) # Point already exist in the tree
