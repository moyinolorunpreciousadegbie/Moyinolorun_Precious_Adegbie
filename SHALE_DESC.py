...
hardness = ["brit" , "frm-sl hd"  ]

shape = ["sb blky" , "blky", "sb blky-sb plty" , ]
...
Colors_crystal_size_textures_accessories = [colors , hardness, shape, lamination , textures , accessories ]
