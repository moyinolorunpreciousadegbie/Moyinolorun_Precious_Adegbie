def Square(mat):
	...
	for r in range(R):
		for c in range(C):
			for r2 in range(R):
				for c2 in range(C):                                                    ########
					if( r <= r2 and c <= c2  and  ( (r2 + 1 - r)!= R or (c2 + 1 - c) !=C ) ):  ## or ( (r2 + 1 - r)== R or (c2 + 1 - c) !=C) or  ( (r2 + 1 - r)!= R or (c2 + 1 - c) == C) ):
						#sum += mat[r:r2][c:c2] 
						if( (  (r2 + 1 - r) * (c2 + 1 - c)  )/ ( r2 + 1 - r)   ==     ( r2 + 1 - r ) or (c2 + 1 - c) and (  (r2 + 1 - r) * (c2 + 1 - c)  )/ (c2 + 1 - c)   ==  ( r2 + 1 - r ) or   (c2 + 1 - c)     ):
