...
sorting = ["v w srt" , "w srt" , "v w-w srt" ]

shape = ["sb ang-rd" , "rd", "w rd" , ]

consolidation = ["uncons-fri clus","fri clus" ]
...
Colors_crystal_size_textures_accessories = [colors , sorting, shape, consolidation , textures , accessories ]
