...
def rect( ALL_RANGES ):
    ...
    for i in range(len(ALL_RANGES)):          #    x1   x2          y1    y2            z1    z2
        for j in range(i+1,len(ALL_RANGES)):  # [ [0]   [3] ]     [ [1]   [4] ]      [ [2]   [5] ]
            #print([i,j])
            # if fn( ALL_RANGES[i][0],  ALL_RANGES[i][3],               ALL_RANGES[j][0],  ALL_RANGES[j][3]) != 0 and
            #    fn( ALL_RANGES[i][1],  ALL_RANGES[i][4],               ALL_RANGES[j][1],  ALL_RANGES[j][4]) != 0 and
            #    fn( ALL_RANGES[i][2],  ALL_RANGES[i][5],               ALL_RANGES[j][2],  ALL_RANGES[j][5]) != 0 :
...
ALL_RANGES = [[0,7],[2,5], [3,4]]# 1
rect( ALL_RANGES )
print() 

ALL_RANGES = [[2,5],[0,7], [3,4]]# 1
rect( ALL_RANGES )
print() 
...
ALL_RANGES = [[2,7],[0,5], [3,4]]# 2    
rect( ALL_RANGES )
print() 


ALL_RANGES = [[0,5],[2,7], [3,4]]# 2
rect( ALL_RANGES )
print()
...
ALL_RANGES = [[2,7],[2,5], [3,4]]# 3
               #     #
rect( ALL_RANGES )
print() 


ALL_RANGES = [[2,5],[2,7], [3,4]]# 3
               #     #
rect( ALL_RANGES )
print() 
...
ALL_RANGES = [[0,3],[4,7], [4,5],[2,3]]
rect( ALL_RANGES )
print()        

ALL_RANGES = [[0,3],[4,7], [4,5],[2,3], [12,15]]
rect( ALL_RANGES )
print()
"""
ln = 0
